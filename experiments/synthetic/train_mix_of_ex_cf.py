"""Train the mixture-of-experts policy via regression."""
...
def _process(
    ...
    n_moe_model: int,
    logging_type: str,
    early_stage_moe_cf_lr: float,
    early_stage_moe_selector_lr: float,
    n_epoch: int,
    ...
    **kwargs,
    ...
    moe_cf_early_stage_policy, _ = initialize_trainable_policy(
        env=env,
        dim_model_emb=dim_model_emb,
    ...
    moe_cf_early_stage_policy, moe_cf_model_selector, moe_cf_training_logs = (
        train_early_stage_with_cf(
            env=env,
            early_stage_policy=moe_cf_early_stage_policy,
            logged_dataset=logged_dataset,
            early_stage_lr=early_stage_moe_cf_lr,
            model_selector_lr=early_stage_moe_selector_lr,
            n_epoch=n_epoch,
    ...
    save_logs(
        ...
        key_param=key_param,
        random_seed=random_seed,
        trained_moe_cf_early_stage_policy=moe_cf_early_stage_policy,
        trained_moe_cf_model_selector=moe_cf_model_selector,
        moe_cf_training_logs=moe_cf_training_logs,
    )
