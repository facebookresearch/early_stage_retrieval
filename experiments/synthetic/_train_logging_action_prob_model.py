"""Fit logging action prob model of the (vanilla) IS."""
...
def _process(
    ...
    data_size: int,
    dim_model_emb: int,
    logging_action_prob_model_lr: Union[int, float],
    ...
    **kwargs,
    ...
    action_prob_model = initialize_trainable_action_prob_model(
        env=env,
        base_model=late_stage_cf_policy.base_model,
    )

    logging_action_prob_model, logging_action_prob_model_training_logs = (
        train_logging_action_prob_model(
            env=env,
            ...
            action_prob_model=action_prob_model,
            action_prob_model_lr=logging_action_prob_model_lr,
    ...
    save_logs(
        ...
        key_param=key_param,
        random_seed=base_random_seed,
        trained_logging_action_prob_model=logging_action_prob_model,
        logging_action_prob_model_training_logs=logging_action_prob_model_training_logs,
    )
