...
class KernelDensityRegressor(BaseModelLearner):
    ...
    use_raw_action_embedding: bool, default=False
        Whether to use raw action embedding or not.
    ...
    def train_model_offline(
        ...
        policy: Union[BaseJointPolicy, BaseSingleStagePolicy]
            The joint policy. Either policy or (early stage policy, late stage policy) should be provided.
