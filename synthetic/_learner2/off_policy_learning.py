...
#         rejection_sampling_weight torch.Tensor, shape (n_samples, n_output_action)
#             The probability of the action given candidate (non-differential).

#         logging_prob: torch.Tensor, shape (n_samples, n_output_action)
...
#         n_candidate_per_model: Optional[List[int]]
...
#         kernel_weight: torch.Tensor, shape (n_samples, n_output_action)
#             The kernel similarity weight between the logging action and the augmented one (non-differential).

#         logging_marginal_prob: torch.Tensor, shape (n_samples, n_output_action)
