...
#         policy_gradient = -early_stage_log_prob * reward[:, 0]
...
#                 require_grad_model_id = torch.randint(
#                     self.n_model,  # pyre-ignore
#                     (n_steps_per_epoch,),
#                 )

#                 for j in range(n_steps_per_epoch):
#                     require_grad_model_id_ = require_grad_model_id[j].item()
#                     n_candidate_action_ = (
#                         (require_grad_model_id_ + 1)
#                         * self.env.n_output_action  # pyre-ignore
#                     )
#                     n_candidate_per_model_ = torch.zeros(
#                         (self.n_model,),
#                         device=self.device,
#                         dtype=torch.long,
#                     )
#                     n_candidate_per_model_[: require_grad_model_id_ + 1] = (
#                         self.env.n_output_action  # pyre-ignore
#                     )

#                     # debugging
#                     require_grad_model_id_ = 0
#                     n_candidate_action_ = 5
...
#                             context=context_,
#                             context_id=context_id_,
#                             n_candidate_action=n_candidate_action_,  # pyre-ignore
...
#                     )
#                     reward_, _ = self.env.reward_model.sample(  # pyre-ignore
#                         context=context_,
#                         latent=latent_,
#                         actions=action_ids_,
#                     )
